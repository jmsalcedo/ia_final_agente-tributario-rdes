...
Del análisis de la figura~\ref{fig:recompensa_por_pais} extraigo tres observaciones relevantes. Primero, las recompensas medias para España y República Dominicana se sitúan en rangos comparables, lo que sugiere que el sistema \textbf{no presenta sesgo significativo} hacia una jurisdicción, a pesar de que el corpus de la AEAT es cuantitativamente mayor que el de la DGII. Segundo, la dispersión (rango intercuartílico) es algo superior en República Dominicana, lo que atribuyo a la menor densidad de documentos indexados para esa jurisdicción: cuando la pregunta toca aspectos no cubiertos suficientemente en los chunks, la recompensa cae. Tercero, la estrategia \texttt{paso\_a\_paso} obtiene medianas ligeramente superiores en ambos países, mientras que \texttt{conciso} muestra mayor varianza, especialmente en consultas que requieren detalle normativo. Estas observaciones refuerzan la conclusión de que el cuello de botella principal del sistema es la calidad y cobertura del corpus, más que la política de prompting seleccionada por el bandit.
